...
from eudplib import EUDDeque, EUDEndIf, EUDFunc, EUDFuncPtr, EUDIf, EUDMethod, EUDStruct, EUDTypedFunc, f_println
from ..objects.wobject import WObject
from ..components.transform import TransformComponent
from typing import Literal, TypeAlias

entity_deque = EUDDeque(1650)()
EntityType: TypeAlias = Literal["Unit", "Sprite", "Location", "Terrain", "Doodads", "Unknown"]
